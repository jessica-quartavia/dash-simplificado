...
/**
 * GET paginado em /rest/v1/{table}.
 * @param {{ table: string, select: string, order?: string|null, filters?: Record<string,string>, pageSize?: number, url?: string, restKey?: string, schema?: string, maxOffset?: number }} opts
 */
