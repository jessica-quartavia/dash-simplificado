...
const TEMPORAL_STOCK = { period: false, status: false, engineer: false, segment: false, search: true, program: true, source: true, month: true, cancelWindow: true };
const SC_STOCK = { period: false, status: true, engineer: true, segment: true, search: false, program: true, minCoverage: true, minSample: true };
...
export const PAGE_FILTER_CONTRACTS = {
  ...
  ep_performance: {
    ...
    period: {
      ...
      dateFieldLabel: null,
      semantics:
        "Sem filtro global de período. Percentual cancelado é composição da carteira (EP atual), não taxa temporal.",
    },
    search: {
      tables: ["engineers"],
    ...
    uiFilters: ["search", "engineerMultiselect", "segment", "program"],
    unimplementedVisualFilters: [],
    notes: [
  ...
  temporal_indicators: {
    ...
    uiFilters: ["search", "program", "source", "month", "cancelWindow"],
    unimplementedVisualFilters: [],
    notes: [
  ...
  statistical_crosses: {
    ...
    period: {
      ...
      dateFieldLabel: null,
      semantics:
        "Sem filtro global de período. População metodológica ativos + cancelados efetivos; filtros de contratação/cancelamento locais quando aplicável.",
    },
    search: { tables: [], fields: {}, codeAvailable: false },
    export: { tables: ["aucTable", "correlationTable", "cohortTable"], formats: ["csv", "xlsx"] },
    uiFilters: ["status", "engineer", "segment", "program", "minCoverage", "minSample"],
    unimplementedVisualFilters: ["hireFrom", "cancelFrom", "matrixVars"],
    notes: [
      "Associações observadas — não implicam causalidade.",
      "Kaplan-Meier e coorte usam permanência cronológica real (sem +365).",
    ],
    components: [
      { id: "sc_summary", type: "kpi", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_discoveries", type: "kpi", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_cancel_block", type: "chart", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_matrices", type: "chart", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_survival", type: "chart", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_cohort", type: "chart", periodSensitive: false, filters: SC_STOCK },
      { id: "sc_correlation", type: "chart", periodSensitive: false, filters: SC_STOCK },
    ],
    exportColumns: [],
  },
  renewal: {
