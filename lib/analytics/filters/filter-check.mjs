...
export function runPageBehavior(pageId) {
  ...
  checks.push(pass("period_ui_expected", pageShowsPeriodUi(pageId) === ["meetings", "financial_updates", "cancellations", "support", "ep_performance"].includes(pageId), pageShowsPeriodUi(pageId) ? "com período" : "sem período"));
  return checks;
}
