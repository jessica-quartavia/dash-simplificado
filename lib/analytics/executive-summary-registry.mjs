...
export const EXECUTIVE_METRIC_REGISTRY = Object.freeze([
  ...
  { id: "renewal_eligible_clients", label: "Clientes aptos para renovação", section: "clientHealth", sourcePage: "renewal", sourceMetricId: "renewal_eligible_clients", visualization: "kpi", filters: FILTER_STOCK, limitations: "Clientes com ciclo válido (> 0) — population.eligibleClients / client-cycle-renewal.mjs valid." },
  ...
  { id: "temporal_signal_distribution", label: "Clientes por quantidade de sinais", section: "temporal", sourcePage: "temporal_indicators", sourceMetricId: "signal_count_distribution", visualization: "hbar", filters: FILTER_PROGRAM_ONLY, limitations: "Faixas 1/2/3/4+ sinais em clientes ativos com sinal (activeRisk.clients) — regra V1." },
]);
