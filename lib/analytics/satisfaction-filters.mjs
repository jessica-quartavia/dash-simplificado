...
import {
  ...
  resolveFilteredOfficialNps,
  resolveSatisfactionQuarter,
} from "./satisfaction.mjs";
...
export function buildScopedSatisfactionView(payload, filters = {}) {
  ...
  const filteredNps = resolveFilteredOfficialNps(scopeInputs.allNpsRows, clientMap, f.program);
  return {
