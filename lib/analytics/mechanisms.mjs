...
const CLIENT_SELECT =
  "id,codigo,name,status,engenheiro_patrimonial,data_inicio_ciclo,created_at,data_churn,email,phone,cpf_digits,phone_digits,linked_user_id,programa";
const CM_SELECT =
...
export async function computeMechanismsPayload() {
  ...
  const baseQvAudit = computeBaseQvMechanismAudit(cmRowsAll);
