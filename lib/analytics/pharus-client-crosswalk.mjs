...
export function auditPharusClientCrosswalk(crosswalk, {
  ...
  if (pharusUserIdsWithMechanisms.size > 0) {
    if (ambiguous > 0) consolidationMode = "consolidated_with_ambiguous";
    else if (unmatchedAppPharus > 0) consolidationMode = "consolidated_with_unmatched";
    else consolidationMode = "full";
  }
