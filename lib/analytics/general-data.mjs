  ...
  return {
    ...
    quality: {
      ...
      statusComposition: {
        ...
        frozenRule: "Congelado bruto sem evidência de cancelamento efetivado (cancelamento tem prioridade).",
        confirmedCancelledRule:
          "Efetivado com evidência; registros archived_at são desconsiderados no mapa analítico.",
        unconfirmedRule:
          "Status Cancelado/Churn bruto sem evidência de efetivação (ausência de evidência, não apenas ausência de data).",
      },
      acquisitionAudit: {
...
export async function computeGeneralDataPayload(options = {}) {
  ...
  return payload;
  }, { page: "general", perfDebug: Boolean(options.perfDebug) });
}
