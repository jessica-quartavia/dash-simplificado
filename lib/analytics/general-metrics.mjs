...
/** V1 usa timezone local para o mês corrente da janela (UTC só no bucket da linha). */
export function currentMonthKeyLocal(now = new Date()) {
...
export function buildAcquisitionMonthSeries(rows, limit = 6, now = new Date()) {
  const nowKey = currentMonthKeyLocal(now);
