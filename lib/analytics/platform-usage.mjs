...
export async function computePlatformUsagePayload() {
  ...
  const summary = {
    ...
    populationParityStatus: authDirectory.size > 0 ? "OK" : "BLOCKED",
    populationParityNote:
      authDirectory.size > 0
        ? null
        : "PHARUS_SUPABASE_SERVICE_ROLE_KEY ausente — população V1 depende de auth.users para excluir @quartavia.com.br e demos.",
  };
