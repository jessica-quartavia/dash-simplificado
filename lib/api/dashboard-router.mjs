...
import { handleInternalMechanismsRenewalProjectionRequest } from "../analytics/internal-mechanisms-renewal-projection-handler.mjs";
...
export const DASHBOARD_PAGE_HANDLERS = Object.freeze({
  ...
  internal_mechanisms_renewal_projection: {
    handler: handleInternalMechanismsRenewalProjectionRequest,
    logPrefix: "internal-mechanisms-renewal-projection",
  },
