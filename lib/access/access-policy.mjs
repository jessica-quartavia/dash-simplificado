...
export const ACCESS_UNAUTHORIZED_MESSAGE = "Seu usuário ainda não possui acesso ao Analytics.";
...
export const ACCESS_GROUP_CODES = Object.freeze(["leaders", "eps", "team_leaders_ep", "quality", "finance"]);
...
export const ACCESS_GROUPS = Object.freeze({
  ...
  quality: { code: "quality", name: "Qualidade", description: "Dados Gerais, Satisfação, Acionamentos, Cancelamento e Renovação." },
...
export function filterPagesForMenu(access) {
  ...
  return PAGE_GROUPS.map((group) => ({
    ...group,
    pages: allowed.filter((page) => page.group === group.id),
